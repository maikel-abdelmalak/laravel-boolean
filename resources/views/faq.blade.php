...
@section('main')
    ...
    <section id="domande" class="container-fluid">
        <div class="prima corso">
            <h2>PRIMA DEL CORSO</h2>
            <p class="domanda">Chi può fare il corso Boolean?</p>
            ...
            <p class="domanda">Che competenze devo avere per iniziare il corso?</p>
            ...
            <p class="domanda">In cosa consiste il processo di selezione?</p>
            ...
            <p class="domanda">Posso seguire il corso mentre lavoro o studio?</p>
